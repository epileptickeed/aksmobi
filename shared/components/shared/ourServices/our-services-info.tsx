...
export const OurServicesInfo: React.FC<Props> = ({ className }) => {
  return (
    <div className="grid grid-cols-2 w-full gap-8">
      <div className="bg-[#1e1e1e] rounded-xl z-10 relative overflow-hidden">
        ...
        <Image
          ...
          width={345}
          height={288}
          className="absolute z-[0] left-[54%] bottom-[-25%] scale-[.7]"
        />
      </div>
      ...
      <div className="bg-[#1e1e1e] rounded-xl relative">
        ...
        <Image
          ...
          width={215}
          height={200}
          className="absolute z-[0] top-[10%] right-[-5%]"
        />
      </div>
      ...
      <div className=" relative col-span-2 overflow-hidden rounded-xl">
        <div className="bg-[#1e1e1e] p-4 flex flex-col gap-4 justify-between z-30">
          <Title text="Покупайте запчасти онлайн" size="md" />
