...
export const Poster: React.FC<Props> = ({ className }) => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "flex items-center justify-between max-lg:p-4 w-full max-lg:flex-col-reverse ",
          className
        )}
      >
        <div className="flex flex-col items-start justify-between gap-4 w-[60%] max-lg:items-center">
          <h1 className="text-[52px] max-lg:text-[20px] font-bold">
